// ============================================================================
// LANDING PAGE - Premium Community Gallery
// File: src/app/page.tsx
// Deskripsi: Homepage profesional dengan design modern & memorable
// ============================================================================
            ...
            <div className="flex gap-3 p-4 bg-white/5 border border-white/10 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                  ...
                  Belum ada kesepakatan resmi dari pengurus PTN.
                </p>
              </div>
            </div>
  ...
  useEffect(() => {
    ...
    if (acceptedTime) {
      ...
      if (timePassed < sevenDaysInMs) {
        // Belum 7 hari, tidak perlu tampilkan
        return
      }
    }
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg sm:text-xl text-gray-400 leading-relaxed max-w-xl">
                  Ruang digital khusus untuk keluarga i.47 PTN. Upload foto kegiatan, arsipkan kenangan berharga, dan nikmati privasi yang sepenuhnya terjaga.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Kenapa <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Lensaptn</span>?
              </h2>
        ...
        <footer className="px-6 py-8 border-t border-white/5">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-gray-500">Lensaptn</span>
            </div>

            {/* Copyright */}
            <p className="text-xs text-gray-600 uppercase tracking-widest">
              &copy; 2026 Ahinxkritinx • Semua Hak Dilindungi
            </p>
